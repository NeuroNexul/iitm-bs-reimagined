...
export default function Home() {
  return (
    <PageWrapper>
      {/* Hero Section */}
      <div className={cn("w-full max-w-7xl mx-auto", "py-24 px-4 sm:px-8")}>
        <div className={cn("flex flex-col lg:flex-row items-center gap-12")}>
          ...
          <div className={cn("flex-1 flex flex-col items-start justify-start")}>
            ...
            <div className={cn("flex flex-col mt-12 gap-4")}>
              <div className="flex flex-row items-center gap-4">
                <AnimatedButton
                  className={cn(
                    "bg-secondary-foreground/70 hover:bg-secondary-foreground/90",
                ...
                <AnimatedButton
                  variant="outline"
                  className={cn(
                    "border-secondary-foreground/70 hover:bg-secondary-foreground/70",
                    "text-secondary-foreground hover:text-foreground transition-all duration-300",
                    "font-medium tracking-wide"
                  )}
                  size="lg"
                >
          ...
          <div className="flex-1 w-full flex justify-center items-center">
            <iframe
              ...
              allowFullScreen
              className="w-full h-auto aspect-video max-w-xl rounded-lg shadow-lg border-2"
            ></iframe>
          </div>
        </div>
      </div>
        ...
        >
          <div
            className={cn(
              ...
              "rounded-lg border-2 shadow-lg p-6 bg-card"
            )}
          >
